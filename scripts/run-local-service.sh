...
export OJ_MINIO_ACCESS_KEY="$MINIO_ROOT_USER"
export OJ_MINIO_SECRET_KEY="$MINIO_ROOT_PASSWORD"
export OJ_DEFAULT_PASSWORD="${OJ_DEFAULT_PASSWORD:-}"
export OJ_FILE_BASE_URL="${OJ_FILE_BASE_URL:-/tmp/oj_files}"
