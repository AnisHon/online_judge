<template>
  <el-card class="solution-card" shadow="hover" @click="$emit('open', solution.solutionId)">
    <div class="solution-card__body">
      <avatar class="solution-card__avatar" :user-id="solution.userId" />
      <div class="solution-card__main">
        <div class="solution-card__author">{{ solution.nikeName }}</div>
