<template>
  <el-card class="solution-card" shadow="hover" @click="$emit('open', solution.solutionId)">
    <div class="solution-card__body">
      <router-link class="solution-card__author-link" :to="authorRoute" @click.stop><avatar class="solution-card__avatar" :user-id="solution.userId" /><span class="solution-card__author">{{ solution.nikeName || '未设置昵称' }}</span></router-link>
...
const authorRoute = computed(() => ({name: 'profile', params: {id: String(props.solution.userId)}}));
</script>
