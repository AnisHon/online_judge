...
public class PagedResult<T> {
    ...
    public static <T, K> PagedResult<T> fromPage(Page<K> page) {
    ...
    public static <T, K> PagedResult<T> fromPage(Page<K> page, List<T> data) {
        PagedResult<T> tPagedResult = fromPage(page);
